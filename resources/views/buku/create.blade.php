                    ...
                    <div class="card-body">
                      <h4 class="card-title">Tambah Buku baru</h4>
                        ...
                        <div class="form-group{{ $errors->has('kategori_id') ? ' has-error' : '' }}">
                            <label for="isbn" class="col-md-4 control-label">Kategori</label>
                            <div class="col-md-6">
                            <select class="form-control" name="kategori_id" value="{{ old('kategori_id') }}" required="">
                                <option value="1">Komputer</option>
                                <option value="2">Akutansi</option>
