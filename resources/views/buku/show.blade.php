                    ...
                    <div class="card-body">
                      ...
                      <form class="forms-sample">
                        ...
                        <div class="form-group{{ $errors->has('npm') ? ' has-error' : '' }}">
                            <label for="isbn" class="col-md-4 control-label">Kode Buku</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('kategori_id') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="kategori_id" disabled="">
                                <option value="1" {{$data->kategori_id === "KOMPUTER" ? "selected" : ""}}>KOMPUTER</option>
                                <option value="2" {{$data->kategori_id === "AKUTANSI" ? "selected" : ""}}>AKUTANSI</option>
                                <option value="3" {{$data->kategori_id === "FISIKA" ? "selected" : ""}}>FISIKA</option>
                            </select>
                            </div>
                        </div>
